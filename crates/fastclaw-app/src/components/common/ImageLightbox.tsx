...
export function openLightbox(src: string, alt?: string) {
  window.dispatchEvent(
    new CustomEvent("fastclaw:lightbox", { detail: { src, alt } }),
  );
}
...
export function ImageLightbox() {
  ...
  useEffect(() => {
    ...
    window.addEventListener("fastclaw:lightbox", handler);
    return () => window.removeEventListener("fastclaw:lightbox", handler);
  }, [reset]);
