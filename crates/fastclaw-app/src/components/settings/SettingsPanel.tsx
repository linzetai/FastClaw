...
import { Settings2, Box, Wrench, Server, Info, ChevronDown, Plus, Pencil, Globe, User, X, RefreshCw, Upload, FolderOpen, FileText, Plug, Trash2, ToggleLeft, ToggleRight, Eye, EyeOff, Zap, CheckCircle, XCircle, Loader2, Shield } from "lucide-react";
...
type SettingsTab = "general" | "models" | "skills" | "mcp" | "security" | "gateway" | "about";
