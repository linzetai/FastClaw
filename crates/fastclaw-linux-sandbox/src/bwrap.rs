...
//! - sensitive subpaths such as `.git`, `.agents`, and `.fastclaw` remain
...
use fastclaw_security::permission_profile::{
        ...
        file_system_sandbox_policy
            ...
            .filter_map(|entry| {
                ...
                if project_subpath != Path::new(".git")
                    ...
                    && project_subpath != Path::new(".fastclaw")
                {
                    return None;
                }
...
mod tests {
    use super::*;
    use fastclaw_security::permission_profile::FileSystemSandboxPolicy;
