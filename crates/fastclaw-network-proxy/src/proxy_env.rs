...
pub const PROXY_ACTIVE_ENV_KEY: &str = "FASTCLAW_PROXY_ACTIVE";

pub const ALLOW_LOCAL_BINDING_ENV_KEY: &str = "FASTCLAW_ALLOW_LOCAL_BINDING";
...
pub const PROXY_GIT_SSH_COMMAND_MARKER: &str = "FASTCLAW_PROXY_GIT_SSH";
